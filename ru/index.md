...
Я закончил бакалавриат факультета [ВМК МГУ](https://cs.msu.ru/) на кафедре системного программирования в 2018 г. Получил магистерскую степень по направлению «компиляторные технологии» факультета [ВМК МГУ](https://cs.msu.ru/) в 2020 г. Я получил степень кандидата физико-математических наук в [Институте системного программирования им. В.П. Иванникова РАН](https://www.ispras.ru/).

Я работаю в отделе компиляторных технологий [ИСП РАН](https://www.ispras.ru/). Я увлечен разработкой инструмента динамического символьного выполнения [Sydr](https://sydr-fuzz.github.io), который позволяет автоматически обнаруживать программные дефекты.
