...
Я работаю в отделе компиляторных технологий [Института системного программирования им. В.П. Иванникова РАН](https://www.ispras.ru/). Я увлечен разработкой инструмента динамического символьного выполнения [Sydr](https://sydr-fuzz.github.io), который позволяет автоматически обнаруживать программные дефекты.
...
## Sydr-Fuzz: Continuous Hybrid Fuzzing and Dynamic Analysis for Security Development Lifecycle \[[статья](https://arxiv.org/abs/2211.11595)\] \[[слайды](/vishnyakov-isprasopen2022.pdf)\]
